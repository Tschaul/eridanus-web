...
import { ILoadMetalOrder } from "../../../lib/model/orders/order";
import autobind from "autobind-decorator";

export class LoadMetalOrderForm extends React.Component<{
    order: ILoadMetalOrder,
    onChange: (o: ILoadMetalOrder) => void
}> {
    render() {
        return (
            <div>
